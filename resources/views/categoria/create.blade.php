                        ...
                        <div class="intro-y box">
                            ...
                            <div id="form-validation" class="p-5">
                                <div class="preview">
                                    ...
                                    <form method="POST" action="{{ route('categoria.store') }}" enctype="multipart/form-data" class="validate-form"><!-- action="{{ route('categoria.store') }}"-->
                                        {!! csrf_field() !!}
                                        <div class="input-form">
                                            ...
                                            <input type="text" name="nombre" wire:model="nombre" id="nombre" class="form-control" placeholder="Nombre" minlength="2" maxlength="30" required>
                                        </div>
