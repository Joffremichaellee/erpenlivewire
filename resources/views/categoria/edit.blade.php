                        ...
                        <div class="intro-y box">
                            ...
                            <div id="form-validation" class="p-5">
                                <div class="preview">
                                    ...
                                    <form method="POST" action="{{ route('categoria.update', $categoria->id) }}" enctype="multipart/form-data" class="validate-form"><!-- action="{{ route('categoria.store') }}"-->
                                        {!! method_field('PUT') !!}
                                        @csrf
                                        <div class="input-form">
                                            ...
                                            <input type="text" name="nombre" value="{{$categoria->nombre}}" wire:model="nombre" id="nombre" class="form-control" placeholder="Nombre" minlength="2" maxlength="30" required>
                                        </div>
                                        <div class="input-form mt-3">
                                            <label for="descripcion" class="form-label w-full flex flex-col sm:flex-row">
                                                descripcion
                                            </label>
                                            <input type="text" name="descripcion" value="{{$categoria->descripcion}}" wire:model="descripcion" id="descripcion" class="form-control" placeholder="descripcion" maxlength="65">
                                        </div>
                                        <div class="input-form mt-3">
